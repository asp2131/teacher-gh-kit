...
config :gitclass, GitclassWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vML6HJIdu7Cy9E+08nn0khfkoBOHktllPpHaE2tQXnOqNoTVn6tpMseN0dlOCSTs",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:gitclass, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:gitclass, ~w(--watch)]}
  ]
...
config :gitclass, GitclassWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/gitclass_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :gitclass, dev_routes: true
